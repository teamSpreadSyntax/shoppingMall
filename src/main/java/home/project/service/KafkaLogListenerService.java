...
//public class KafkaLogListenerService {
//
...
//    }
//
//    @KafkaListener(topics = "coupon-events", groupId = "log-consumers")
//    public void consumeCouponAssignToMemberLog(String message) {
//        System.out.println("coupon_assigned_to_member: " + message);
//        sendLogToElk("coupon-events", message);
//        sendLogToWebSocket(message);  // WebSocket으로 전송
//    }
//
//    @KafkaListener(topics = "coupon-events", groupId = "log-consumers")
//    public void consumeCouponAssignToProductLog(String message) {
//        System.out.println("coupon_assigned_to_product: " + message);
//        sendLogToElk("coupon-events", message);
//        sendLogToWebSocket(message);  // WebSocket으로 전송
//    }
//
