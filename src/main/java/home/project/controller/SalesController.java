...
public class SalesController {
    ...
    @Operation(summary = "관리자를 위한 판매 통합 조회 메서드", description = "브랜드명, 카테고리명, 상품명 및 일반 검색어로 판매 내역을 조회합니다. 모든 조건을 만족하는 판매 내역을 조회합니다. 검색어가 없으면 전체 판매 내역을 조회합니다.")
    @ApiResponses(value = {
    ...
    @GetMapping("/admin/sold_products")
    ...
    public ResponseEntity<?> searchSoldProducts(
        ...
        Page<ProductResponseForManager> productPage = productService.findSoldProducts(brand, category, productName, content, pageable);
