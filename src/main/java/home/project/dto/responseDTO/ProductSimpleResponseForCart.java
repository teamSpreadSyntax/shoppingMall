...
public class ProductSimpleResponseForCart {
    ...
    public ProductSimpleResponseForCart(Long id, String name, String brand, Long price, Integer discountRate, String mainImageUrl, Integer quantity, String color) {
        this.id = id;
        this.name = name;
        this.brand = brand;
        this.price = price;
